...
public class AutoGenDAO extends BaseAutoGen {
	...
	private void genSqlmap(SourceGenerator sourceGenerator, Class<?> clazz, File baseFile, FileWriter fileWriter)
			throws IOException {
		// for sqlmap
	...
	private void genDAO(SourceGenerator sourceGenerator, Class<?> clazz, File baseFile, FileWriter fileWriter,
			File javaMainSrcPath) {
	...
	private void genIbatisDAO(SourceGenerator sourceGenerator, Class<?> clazz, File baseFile, FileWriter fileWriter,
			File javaMainSrcPath) throws IOException {
