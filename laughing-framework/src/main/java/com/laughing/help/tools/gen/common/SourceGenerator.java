...
import com.laughing.help.tools.gen.dao.DefaultMappingPolicy;
import com.laughing.help.tools.gen.dao.DefaultResultRender;
import com.laughing.help.tools.gen.dao.DomainField;
import com.laughing.help.tools.gen.dao.IbatisResult;
import com.laughing.help.tools.gen.dao.Keywords;
import com.laughing.help.tools.gen.dao.MappingPolicy;
import com.laughing.help.tools.gen.dao.OptionEnum;
import com.laughing.help.tools.gen.dao.ResultRender;
import com.laughing.help.tools.gen.dao.SqlTypes;
...
public class SourceGenerator {
	...
	private void renderList(Class<?> domainClass, File moduleDir, String actionContext, FileWriter fileWriter) {
		...
		String deleteDoAction = "$baseModule.setTarget('" + getActionContext(actionContext) + alias
				+ "/doDelete').param('id', $" + alias + ".id).withToken()";
		String editPageAction = "$baseModule.setTarget('" + getActionContext(actionContext) + alias
				+ "/edit').param('id', $" + alias + ".id)";
		String detailPageAction = "$baseModule.setTarget('" + getActionContext(actionContext) + alias
				+ "/detail').param('id', $" + alias + ".id)";

		String paginationWidget = "$widget.setTemplate('common/pagination').addToContext('pageModule', $baseModule.setTarget('"
				+ getActionContext(actionContext) + alias + "/list')).addToContext('query', $query)";
